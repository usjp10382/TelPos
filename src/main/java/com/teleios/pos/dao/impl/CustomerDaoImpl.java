...
public class CustomerDaoImpl implements CustomerDao {
	...
	private static final String CREATE_CUSTOMER_SQL = "INSERT INTO customer_schema.customer(first_name,last_name,address,mobile_number,create_by,create_date,cus_state) "
			+ "VALUES(:first_name,:last_name,:address,:mobile_number,:create_by,:create_date,:cus_state)";

	// Define Customer rFetch SQL Queries
	private static final String SELECT_CUSTOMER_BY_NUMBER = "SELECT customer_id,first_name,last_name,address,mobile_number,create_by,create_date,cus_state FROM "
			+ "customer_schema.customer WHERE customer_id=?";
	private static final String SELECT_ALLACTIVE_CUSTOMERS = "SELECT customer_id,first_name,last_name,address,mobile_number,create_by,create_date,cus_state FROM "
